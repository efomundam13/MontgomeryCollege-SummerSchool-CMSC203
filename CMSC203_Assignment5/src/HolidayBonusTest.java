...
public class HolidayBonusTest {
	...
	public void tearDown() throws Exception {
		...
		public void testCalculateHolidayBonusB() {
			...
			assertEquals(1000.0,result[2],.001);
			assertEquals(1750.0,result[3],.001);
	...
	public void testCalculateTotalHolidayBonusA() {
		assertEquals(12000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet1, 5000, 1000, 2000),.001);
		assertEquals(18000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet2, 5000, 1000, 2000),.001);
		assertEquals(18000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet3, 5000, 1000, 2000),.001);
		assertEquals(19000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet4, 5000, 1000, 2000),.001);
	}
	...
	public void testCalculateTotalHolidayBonusB() {
		assertEquals(2750.0,HolidayBonus.calculateTotalHolidayBonus(dataSet1, 1000,250,500),.001);
		assertEquals(4000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet2, 1000,250,500),.001);
		assertEquals(4000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet3, 1000,250,500),.001);
		assertEquals(4000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet4, 1000,250,500),.001);
	}
}